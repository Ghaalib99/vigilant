        ...
        <div className="pb-2 col-span-2 shadow-md rounded-lg">
          <div className="flex relative items-center px-6">
            ...
            <div
              ...
              className="flex  relative border rounded-lg px-3 py-1 bg-white"
            >
              <div className="pb-0 font-semibold flex items-center gap-6 cursor-pointer">
                {option}{" "}
              </div>
              <div
                className={`absolute left-0 top-10 shadow-md border z-40 bg-white rounded-lg p-1 ${
                  !showOption && "hidden"
                }`}
              >
                <div
                  ...
                  className="pl-3 pr-6 cursor-pointer hover:bg-gray-100 rounded-md py-1"
                >
                  Monthly
                </div>
                <div
